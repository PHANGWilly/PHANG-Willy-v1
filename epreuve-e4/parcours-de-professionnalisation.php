...
<head>
    ...
    <title>Parcours de professionnalisation - PHANG Willy</title>
    ...
    <link rel="stylesheet" href="<?php echo $get_perma_link;?>css/parcours-de-professionnalisation.css">
...
<body>
    ...
    <div class="title">
        <h1 class="h1-title">Parcours de professionnalisation</h1>
    </div>

    <div class="content">
        <iframe src="<?php echo $get_perma_link;?>uploads/E4_Tableaux_de_syntheses_des_realisations_professionelles_PHANG_Willy.pdf" height="900px" width="100%"></iframe>
    </div>
